...
\includegraphics[width=0.5\linewidth]{../../plots/chowdhury-model-figure.pdf}\\
\includegraphics[width=0.5\linewidth]{../../plots/crystal-model-figure.pdf}%
\caption{\textbf{Hinge model compared with dynein micrographs.} \textit{Left:} Model superimposed over ---maybe the burgess paper is bad since it uses dynein c, which seems like an axonemal dynein}
