...
The dynein model used in this paper consists of two systems meant to mimic the motor's dynamics in its post-powerstroke and pre-powerstroke states. These systems, shown in Figure \ref{fig:model-cartoon},
...
\caption{Cartoon representation of model systems. \textbf{Left}: Post-powerstroke, \textbf{right}: pre-powerstroke.}
