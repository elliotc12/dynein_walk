...
\begin{figure*}[tbhp]
\centering
\includegraphics[width=0.3\linewidth]{figures/onebound-cartoon.pdf}%
\includegraphics[width=0.3\linewidth]{figures/bothbound-cartoon.pdf}%
\includegraphics[width=0.3\linewidth]{figures/schematic-1-superimposed}\\
\includegraphics[width=0.15\linewidth]{../../plots/poststroke-figure.pdf}%
\includegraphics[width=0.15\linewidth]{../../plots/prestroke-figure.pdf}%
\includegraphics[width=0.3\linewidth]{figures/schematic-binding-angle}
\caption{}
