...
\begin{figure}[tbhp]
  \centering
  \includegraphics[width=0.5\columnwidth]{figures/model-cartoon-simple}%
  \includegraphics[width=0.5\columnwidth]{../../plots/bothbound_stroke_angles_bd.pdf}\\
  \includegraphics[width=0.5\columnwidth]{../../plots/bothbound_stroke_taily_positions}%
  \includegraphics[width=0.5\columnwidth]{../../plots/bothbound_stroke_tailx_positions}\\
  \includegraphics[width=0.5\columnwidth]{../../plots/onebound_stroke_tailx_positions}%
  \includegraphics[width=0.5\columnwidth]{../../plots/bothbound_stroke_angles_md}\\
  \caption{\textbf{Model behavior during power stroke.}}
\label{fig:stroke}
\end{figure}
