...
\begin{figure}[tbhp]
\centering
\includegraphics[width=\linewidth]{../../plots/paper_time_vs_length}
...
\begin{figure}[tbhp]
  \centering
  \includegraphics[width=0.5\linewidth]{../../plots/paper_stepping_length_histogram}
  \includegraphics[width=0.5\linewidth]{../../plots/paper_dwell_time_histogram}
  \includegraphics[width=0.5\linewidth]{../../plots/paper_displacement_vs_step_length.pdf}
  \includegraphics[width=0.5\linewidth]{../../plots/paper_unbinding_probability_vs_L.pdf}
...
\begin{figure}[tbhp]
  ...
  \includegraphics[width=0.5\linewidth]{../../plots/paper_onebound_histogram.pdf}
