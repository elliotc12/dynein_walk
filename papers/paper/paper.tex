...
\captionsetup[subfigure]{singlelinecheck=off,justification=raggedright, margin=0pt, parskip=0, skip=0pt}
...
\begin{figure}[tbhp]
  \centering
  \begin{subfigure}[]{0.8\columnwidth}\caption{}\includegraphics[width=\columnwidth]{figures/winch-powerstroke-cartoon}\end{subfigure}\vspace{10pt}\\
