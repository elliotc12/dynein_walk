...
Describe fig:stroke results here.
The transition rate from pre->post powerstroke compares roughly with MD simulations of the powerstroke \cite{mdstroke}. - is this actually true?
