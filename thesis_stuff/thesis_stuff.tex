...
\begin{figure}[h!]
  ...
  \begin{minipage}[b]{0.45\textwidth}
    ...
    \caption{Pre-powerstroke equilibrium angles from EM tomography. Note: Ignore binding angle, the MTBD shouldn't actually be bound to MT.}
  \end{minipage}
...
This is an older (2007) paper presenting a chemical model. It gives more MT dissociation constants for several different dyneins, and averages them as: $K_{d,pre} = 0.2uM$, $K_{d,post} > 10uM$. They determine these by adding a known concentration of Dynein apo, ATP, ADP-Pi or ADP, adding microtubules, removing MT-Dynein dimers and remeasuring concentration. These parameters are good in that equilibrium constants (as opposed to rate constants) \textit{don't} take into account kinetics, only free energy change...right?\\
