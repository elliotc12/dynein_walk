...
By adding coordinates for br to mr, mr to t, and t to ml, we simplify one side of our equations. \\
...
\frac{1}{L_{s}} \Big(\dot{Y}_{br} + \dot{Y}_{t } - \frac{1}{\gamma}F_{ymr} - \frac{1}{\gamma}F_{ybr} - R_{ymr} - R_{ybr} \Big)(\cos(\Theta_{mr}-\pi))\\
  - \frac{1}{L_{s}}\Big(\dot{Y}_{br} + \dot{Y}_{t } - \frac{1}{\gamma}F_{xmr} - \frac{1}{\gamma}F_{xbr} - R_{xmr} - R_{xbr} \Big)(\sin(\Theta_{mr}-\pi))
\end{multline}
...
\begin{multline}
\dot{\Theta}_{ml} =
\Big(\frac{1}{L_s}\cos(\Theta_{ml})\Big) \Big(\dot{Y}_{mr} + \dot{X}_{br} + \dot{Y}_{ml}
...
\begin{multline}
\dot{\Theta}_{bl} =
\frac{1}{L_t}\cos(\Theta_{bl})\Big(\dot{Y}_{bl} + \dot{Y}_{t } + \dot{Y}_{mr} + \dot{Y}_{br}
- \frac{1}{\gamma}F_{yml} - \frac{1}{\gamma}F_{yt } - \frac{1}{\gamma}F_{ymr} - \frac{1}{\gamma}F_{ybr} - R_{yml} - R_{yt} - R_{ymr} - R_{ybr} \Big)\\
- \frac{1}{L_t}\sin(\Theta_{bl})\Big(\dot{X}_{bl} + \dot{X}_{t } + \dot{X}_{mr} + \dot{X}_{br}
 - \frac{1}{\gamma}F_{xml} - \frac{1}{\gamma}F_{xt } - \frac{1}{\gamma}F_{xmr} - \frac{1}{\gamma}F_{xbr} - R_{xml} - R_{xt } - R_{xmr} - R_{xbr} \Big)
\end{multline}
