...
\begin{align}
  X_{nm} &= \frac{L_s^2L^2 - L_t^2L^2 - L_s^2L_{f}^2 + L_t^2L_{f}^2}{4L_n^2L} + \frac{L + L_s^2 + L_n^2 - L_t^2 - L_{f}^2}{4L}\\
  &\mp L_s\sqrt{1-\frac{L^4 + L_f^4 - 2L^2L_f^2}{4L^2L_{n}^2} - \frac{L_n^2 + 2L^2 - 2L_f^2}{4L^2}}*\\
  &\sqrt{1-\frac{L_s^4 + L_t^4 - 2L_s^2L_t^2}{4L_{s}^2L_{n}^2} - \frac{L_n^2 + 2L_s^2 - 2L_t^2}{4L_s^2}}\\
  Y_{nm} &= \frac{L_{s}^2+L_{n}^2-L_{t}^2}{2L_{n}}\sqrt{1-\frac{L^4 + L_f^4 - 2L^2L_f^2}{4L^2L^2_{n}} - \frac{L_n^2 + 2L^2 - 2L_f^2}{4L^2}}\\
  &\pm L_s\frac{L^2+L_{n}^2-L_{f}^2}{2LL_{n}}\sqrt{1 - \frac{L_s^4 + L_t^4 - 2L_s^2L_t^2}{4L_s^2L_n^2} - \frac{L_n^2 + 2L_s^2 - 2L_f^2}{4L_s^2}}\\
\end{align}


Now i'm here. Just fixed the above, now go redo these derivations.\\
...
\begin{align}
  ...
  *\left(\frac{-2L_n^2L_f - 2L_fL^2 - 2L_fL_n^2 + 4L_f^3}{4L_{s}^2L_{n}^2}\right)\Bigg)\dot{L}_f\\
    %% &+ \Bigg(\frac{-L_s^2L_{f} - L_n^2L_{f} + L_t^2L_{f}}{2L_n^2L} \mp L_s\frac{\sqrt{1-\frac{L_{s}^4 + L_n^2L_{s}^2 - L_t^2L_{s}^2 + L_s^2L_{n}^2 + L_{n}^4 - L_t^2L_{n}^2 - L_s^2L_{t}^2 - L_n^2L_{t}^2 + L_{t}^4}{2L_{s}L_{n}}}}{2\sqrt{1-\frac{L^4 + L_n^2L^2 - L_f^2L^2 + L^2L_{n}^2 + L_{n}^4 - L_f^2L_{n}^2 - L^2L_{f}^2 + L_n^2L_{f}^2 + L_{f}^4}{2LL_{n}}}}*\\
  %% &\left(-\frac{-2L_fL^2 - 2L^2L_{f} + 4L_{f}^3}{2LL_{n}}\right)\Bigg)\dot{L}_f\\
\end{align}
...
\begin{align}
  ...
  *\left(\frac{-2L_f^2L_n - 2L_nL^2 - 2L_nL_f^2 + 4L_n^3}{4L_{s}^2L_f^2}\right)\Bigg)\dot{L}_n\\
    %% &+ \Bigg(\frac{-L_s^2L_n - L_f^2L_n + L_t^2L_n}{2L_f^2L} \mp L_s\frac{\sqrt{1-\frac{L_{s}^4 + L_f^2L_{s}^2 - L_t^2L_{s}^2 + L_s^2L_f^2 + L_f^4 - L_t^2L_f^2 - L_s^2L_{t}^2 - L_f^2L_{t}^2 + L_{t}^4}{2L_{s}L_f}}}{2\sqrt{1-\frac{L^4 + L_f^2L^2 - L_n^2L^2 + L^2L_f^2 + L_f^4 - L_n^2L_f^2 - L^2L_n^2 + L_f^2L_n^2 + L_n^4}{2LL_f}}}*\\
  %% &\left(-\frac{-2L_nL^2 - 2L^2L_n + 4L_n^3}{2LL_f}\right)\Bigg)\dot{L}_f\\
\end{align}
