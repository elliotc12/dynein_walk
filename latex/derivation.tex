...
\begin{align}  
  \dot{X}_{bb} &= 0 \\
  \dot{X}_{bm} &= \frac{1}{\gamma} \Big(F_{xml} + \mn \lambda_{ls}(X_{bm} - X_{bb}) + \lambda_{lt}(X_{t } - X_{bm}) \Big) + R_{xml} \\
  \dot{X}_{t } &= \frac{1}{\gamma} \Big(F_{xt } + \mn \lambda_{lt}(X_{t } - X_{bm}) + \lambda_{rt}(X_{fm} - X_{t }) \Big) + R_{xt } \\
  \dot{X}_{fm} &= \frac{1}{\gamma} \Big(F_{xmr} + \mn \lambda_{rt}(X_{fm} - X_{t }) + \lambda_{rs}(X_{fb} - X_{fm}) \Big) + R_{xmr} \\
  \dot{X}_{fb} &= \frac{1}{\gamma} \Big(F_{xbr} + \mn \lambda_{rs}(X_{fb} - X_{fm})                                 \Big) + R_{xbr}
\end{align}

\begin{align}  
  \dot{Y}_{bb} &= 0 \\
  \dot{Y}_{bm} &= \frac{1}{\gamma} \Big(F_{yml} + \mn \lambda_{ls}(Y_{bm} - Y_{bb}) + \lambda_{lt}(Y_{t } - Y_{bm}) \Big) + R_{yml} \\
  \dot{Y}_{t}  &= \frac{1}{\gamma} \Big(F_{yt } + \mn \lambda_{lt}(Y_{t } - Y_{bm}) + \lambda_{rt}(Y_{fm} - Y_{t }) \Big) + R_{yt } \\
  \dot{Y}_{fm} &= \frac{1}{\gamma} \Big(F_{ymr} + \mn \lambda_{rt}(Y_{fm} - Y_{t }) + \lambda_{rs}(Y_{fb} - Y_{fm}) \Big) + R_{ymr} \\
  \dot{Y}_{fb} &= \frac{1}{\gamma} \Big(F_{ybr} + \mn \lambda_{rs}(Y_{fb} - Y_{fm})                                 \Big) + R_{ybr}
\end{align}
...
\begin{align}
  &L_{s}\sin(\Theta_{bb})  \dot{\Theta}_{bb} = \frac{1}{\gamma}F_{xml} + \mn\frac{1}{\gamma}\lambda_{ls}(X_{bm} - X_{bb}) + \frac{1}{\gamma}\lambda_{lt}(X_{t } - X_{bm}) + R_{xml} \\
  &L_{s}\sin(\Theta_{bb})  \dot{\Theta}_{bb} + L_{t}\sin(\Theta_{bm})      \dot{\Theta}_{bm} = \frac{1}{\gamma}F_{xt } + \mn\frac{1}{\gamma}\lambda_{lt}(X_{t } - X_{bm}) + \frac{1}{\gamma}\lambda_{rt}(X_{fm} - X_{t }) + R_{xt } \\
  &L_{s}\sin(\Theta_{bb})  \dot{\Theta}_{bb} + L_{t}\sin(\Theta_{bm})      \dot{\Theta}_{bm} + L_{t}\sin(\Theta_{fm}-\pi)  \dot{\Theta}_{fm} = \frac{1}{\gamma}F_{xmr} + \mn\frac{1}{\gamma}\lambda_{rt}(X_{fm} - X_{t }) + \frac{1}{\gamma}\lambda_{rs}(X_{fb} - X_{fm}) + R_{xmr} \\
  &L_{s}\sin(\Theta_{bb})  \dot{\Theta}_{bb} + L_{t}\sin(\Theta_{bm})      \dot{\Theta}_{bm} + L_{t}\sin(\Theta_{fm}-\pi)  \dot{\Theta}_{fm} + L_{s}\sin(\Theta_{fb}-\pi)  \dot{\Theta}_{fb} = \frac{1}{\gamma}F_{xbr} + \mn\frac{1}{\gamma}\lambda_{rs}(X_{fb} - X_{fm}) + R_{xbr}
\end{align}

\begin{align}
  &\mn L_{s}\cos(\Theta_{bb})  \dot{\Theta}_{bb} = \frac{1}{\gamma}F_{yml} + \mn \frac{1}{\gamma}\lambda_{ls}(Y_{bm} - Y_{bb}) + \frac{1}{\gamma}\lambda_{lt}(Y_{t } - Y_{bm}) + R_{yml} \\
  &\mn L_{s}\cos(\Theta_{bb})  \dot{\Theta}_{bb} + \mn L_{t}\cos(\Theta_{bm})  \dot{\Theta}_{bm}  = \frac{1}{\gamma}F_{yt } + \mn \frac{1}{\gamma}\lambda_{lt}(Y_{t } - Y_{bm}) + \frac{1}{\gamma}\lambda_{rt}(Y_{fm} - Y_{t }) + R_{yt } \\
  &\mn L_{s}\cos(\Theta_{bb})  \dot{\Theta}_{bb} + \mn L_{t}\cos(\Theta_{bm})  \dot{\Theta}_{bm} + \mn L_{t}\cos(\Theta_{fm}-\pi)  \dot{\Theta}_{fm} = \frac{1}{\gamma}F_{ymr} + \mn \frac{1}{\gamma}\lambda_{rt}(Y_{fm} - Y_{t }) + \frac{1}{\gamma}\lambda_{rs}(Y_{fb} - Y_{fm}) + R_{ymr} \\
  &\mn L_{s}\cos(\Theta_{bb})  \dot{\Theta}_{bb} + \mn L_{t}\cos(\Theta_{bm})  \dot{\Theta}_{bm} + \mn L_{t}\cos(\Theta_{fm}-\pi)  \dot{\Theta}_{fm} + \mn L_{s}\cos(\Theta_{fb}-\pi)  \dot{\Theta}_{fb} = \frac{1}{\gamma}F_{ybr} + \mn \frac{1}{\gamma}\lambda_{rs}(Y_{fb} - Y_{fm}) + R_{ybr}
\end{align}
...
\begin{align}
  L_{s}\sin(\Theta_{bb})      \dot{\Theta}_{bb} &= \frac{1}{\gamma}F_{xml} - \frac{1}{\gamma}\lambda_{ls}(X_{bm} - X_{bb}) + \frac{1}{\gamma}\lambda_{lt}(X_{t } - X_{bm}) + R_{xml} \\
  L_{t}\sin(\Theta_{bm})      \dot{\Theta}_{bm} &= \frac{1}{\gamma}F_{xt } - \frac{2}{\gamma}\lambda_{lt}(X_{t } - X_{bm}) + \frac{1}{\gamma}\lambda_{rt}(X_{fm} - X_{t }) + R_{xt } - \frac{1}{\gamma}F_{xml} - \mn\frac{1}{\gamma}\lambda_{ls}(X_{bm} - X_{bb}) - R_{xml} \\
  L_{t}\sin(\Theta_{fm}-\pi)  \dot{\Theta}_{fm} &= \frac{1}{\gamma}F_{xmr} - \frac{2}{\gamma}\lambda_{rt}(X_{fm} - X_{t }) + \frac{1}{\gamma}\lambda_{rs}(X_{fb} - X_{fm}) + R_{xmr} - \frac{1}{\gamma}F_{xt } - \mn\frac{1}{\gamma}\lambda_{lt}(X_{t } - X_{bm}) - R_{xt } \\
  L_{s}\sin(\Theta_{fb}-\pi)  \dot{\Theta}_{fb} &= \frac{1}{\gamma}F_{xbr} - \frac{2}{\gamma}\lambda_{rs}(X_{fb} - X_{fm}) + R_{xbr} - \frac{1}{\gamma}F_{xmr} - \mn\frac{1}{\gamma}\lambda_{rt}(X_{fm} - X_{t }) - R_{xmr} 
\end{align}

\begin{align}
  \mn L_{s}\cos(\Theta_{bb})      \dot{\Theta}_{bb} &= \frac{1}{\gamma}F_{yml} - \frac{1}{\gamma}\lambda_{ls}(Y_{bm} - Y_{bb}) + \frac{1}{\gamma}\lambda_{lt}(Y_{t } - Y_{bm}) + R_{yml} \\
  \mn L_{t}\cos(\Theta_{bm})      \dot{\Theta}_{bm} &= \frac{1}{\gamma}F_{yt } - \frac{2}{\gamma}\lambda_{lt}(Y_{t } - Y_{bm}) + \frac{1}{\gamma}\lambda_{rt}(Y_{fm} - Y_{t }) + R_{yt } - \frac{1}{\gamma}F_{yml} - \mn \frac{1}{\gamma}\lambda_{ls}(Y_{bm} - Y_{bb}) - R_{yml}\\
  \mn L_{t}\cos(\Theta_{fm}-\pi)  \dot{\Theta}_{fm} &= \frac{1}{\gamma}F_{ymr} - \frac{2}{\gamma}\lambda_{rt}(Y_{fm} - Y_{t }) + \frac{1}{\gamma}\lambda_{rs}(Y_{fb} - Y_{fm}) + R_{ymr} - \frac{1}{\gamma}F_{yt } - \mn \frac{1}{\gamma}\lambda_{lt}(Y_{t } - Y_{bm}) - R_{yt } \\
  \mn L_{s}\cos(\Theta_{fb}-\pi)  \dot{\Theta}_{fb} &= \frac{1}{\gamma}F_{ybr} - \frac{2}{\gamma}\lambda_{rs}(Y_{fb} - Y_{fm}) + R_{ybr} - \frac{1}{\gamma}F_{ymr} - \mn \frac{1}{\gamma}\lambda_{rt}(Y_{fm} - Y_{t }) - R_{ymr} 
\end{align}
\end{comment}
...
\begin{align}  
  \dot{X}_{bm} &= \dot{X}_{bb} + \mn L_{s}\sin(\Theta_{bb})\dot{\Theta}_{bb} = \frac{1}{\gamma}F_{xml} + \mn\frac{1}{\gamma}\lambda_{ls}(X_{bm} - X_{bb}) + \frac{1}{\gamma}\lambda_{lt}(X_{t } - X_{bm}) + R_{xml} \\
  \dot{X}_{t}  &= \dot{X}_{bm} + \mn L_{t}\sin(\Theta_{bm})\dot{\Theta}_{bm} = \frac{1}{\gamma}F_{xt } + \mn\frac{1}{\gamma}\lambda_{lt}(X_{t } - X_{bm}) + \frac{1}{\gamma}\lambda_{rt}(X_{fm} - X_{t }) + R_{xt } \\
  \dot{X}_{fm} &= \dot{X}_{t } + L_{t}\sin(\Theta_{fm})\dot{\Theta}_{fm} = \frac{1}{\gamma}F_{xmr} + \mn\frac{1}{\gamma}\lambda_{rt}(X_{fm} - X_{t }) + \frac{1}{\gamma}\lambda_{rs}(X_{fb} - X_{fm}) + R_{xmr} \\
  \dot{X}_{fb} &= \dot{X}_{fm} + L_{s}\sin(\Theta_{fb})\dot{\Theta}_{fb} = \frac{1}{\gamma}F_{xbr} + \mn\frac{1}{\gamma}\lambda_{rs}(X_{fb} - X_{fm}) + R_{xbr}
\end{align}

\begin{align}  
  \dot{Y}_{bm} &= \dot{Y}_{bb} + L_{s}\cos(\Theta_{bb})\dot{\Theta}_{bb} = \frac{1}{\gamma}F_{yml} + \mn\frac{1}{\gamma}\lambda_{ls}(Y_{bm} - Y_{bb}) + \frac{1}{\gamma}\lambda_{lt}(Y_{t } - Y_{bm}) + R_{yml} \\
  \dot{Y}_{t}  &= \dot{Y}_{bm} + L_{t}\cos(\Theta_{bm})\dot{\Theta}_{bm} = \frac{1}{\gamma}F_{yt } + \mn\frac{1}{\gamma}\lambda_{lt}(Y_{t } - Y_{bm}) + \frac{1}{\gamma}\lambda_{rt}(Y_{fm} - Y_{t }) + R_{yt } \\
  \dot{Y}_{fm} &= \dot{Y}_{t } + \mn L_{t}\cos(\Theta_{fm})\dot{\Theta}_{fm} = \frac{1}{\gamma}F_{ymr} + \mn\frac{1}{\gamma}\lambda_{rt}(Y_{fm} - Y_{t }) + \frac{1}{\gamma}\lambda_{rs}(Y_{fb} - Y_{fm}) + R_{ymr} \\
  \dot{Y}_{fb} &= \dot{Y}_{fm} + \mn L_{s}\cos(\Theta_{fb})\dot{\Theta}_{fb} = \frac{1}{\gamma}F_{ybr} + \mn\frac{1}{\gamma}\lambda_{rs}(Y_{fb} - Y_{fm}) + R_{ybr}
\end{align}
...
\begin{multline}
\mn\frac{1}{\gamma}\lambda_{ls}(X_{bm} - X_{bb}) =
...
\begin{multline}
\mn\frac{1}{\gamma}\lambda_{lt}(X_{t } - X_{bm}) =
...
\begin{equation}
\mn\frac{1}{\gamma}\lambda_{rt}(X_{fm} - X_{t }) =
...
\begin{equation}
\mn\frac{1}{\gamma}\lambda_{rs}(X_{fb} - X_{fm}) = 
\dot{X}_{fm} + L_{s}\sin(\Theta_{fb})\dot{\Theta}_{fb} - R_{xbr} - \frac{1}{\gamma}F_{xbr}
\label{eq:Dx}
\end{equation}%Fix'd
...
\begin{multline}
\mn\frac{1}{\gamma}\lambda_{ls}(Y_{bm} - Y_{bb}) =
...
\begin{multline}
\mn\frac{1}{\gamma}\lambda_{lt}(Y_{t } - Y_{bm}) =
...
\begin{equation}
\mn\frac{1}{\gamma}\lambda_{rt}(Y_{fm} - Y_{t }) =
...
\begin{equation}
\mn\frac{1}{\gamma}\lambda_{rs}(Y_{fb} - Y_{fm}) = \dot{Y}_{fm} + \mn L_{s}\cos(\Theta_{fb})\dot{\Theta}_{fb} - R_{ybr} - \frac{1}{\gamma}F_{ybr}
\label{eq:Dy}
\end{equation}%Fix'd
...
\begin{equation}
-\frac{1}{\gamma}\lambda_{rt} = \Big( \dot{X}_{t } + L_{t}\sin(\Theta_{fm})\dot{\Theta}_{fm} - R_{xmr} - \frac{1}{\gamma}F_{xmr}
+ \dot{X}_{fm} + L_{s}\sin(\Theta_{fb})\dot{\Theta}_{fb} - R_{xbr} - \frac{1}{\gamma}F_{xbr}\Big) \frac{1}{(X_{fm} - X_{t })}
\end{equation}

\begin{equation}
-\frac{1}{\gamma}\lambda_{rt} = \Big( \dot{Y}_{t } - L_{t}\cos(\Theta_{fm})\dot{\Theta}_{fm} - R_{ymr} - \frac{1}{\gamma}F_{ymr}
...
\begin{equation}
-\frac{1}{\gamma}\lambda_{rs} = \big( \dot{Y}_{fm} - L_{s}\cos(\Theta_{fb})\dot{\Theta}_{fb} - R_{ybr} - \frac{1}{\gamma}F_{ybr}\big) \frac{1}{(Y_{fb} - Y_{fm})}
\end{equation}

\begin{equation}
-\frac{1}{\gamma}\lambda_{rs} = \big( \dot{X}_{fm} + L_{s}\sin(\Theta_{fb})\dot{\Theta}_{fb} - R_{xbr} - \frac{1}{\gamma}F_{xbr} \big) \frac{1}{(X_{fb} - X_{fm})}
\end{equation}
