...
Also by the law of cosines, we can see that:

\begin{equation}
   \Theta_{1} = \cos^{-1}(\frac{L^2+L_n^2-L_f^2}{2LL_n})
\end{equation}

We use this to find the value of $X_{t}$ and $Y_{t}$:
...
This is getting ugly and complicated. I will not do it. I will do it when I need to. \\
\section{Cartesian from Angular Coordinates}
This section lays out the definitions of the coordinates of the Dynein model. \\
\begin{align}
  X_{nb} &= 0 \\
