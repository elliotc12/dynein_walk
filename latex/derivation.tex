...
\begin{align}
  X_{nm} &= \frac{L_{s}}{L_{n}}\Bigg( \Big(\frac{L^2+L_{n}^2-L_{f}^2}{2L}\Big)\Big(\frac{L_{s}^2+L_{n}^2-L_{t}^2}{2L_{s}}\Big) \mp \sqrt{L_{n}^2-\bigg(\frac{L^2+L_{n}^2-L_{f}^2}{2L}\bigg)^2}\sqrt{L_{n}^2-\bigg(\frac{L_{s}^2+L_{n}^2-L_{t}^2}{2L_{s}}\bigg)^2} \Bigg) \\
  Y_{nm} &= \frac{L_{s}}{L_{n}}\Bigg(\frac{L_{s}^2+L_{n}^2-L_{t}^2}{2L_{s}}\sqrt{L_{n}^2-\bigg(\frac{L^2+L_{n}^2-L_{f}^2}{2L}\bigg)^2} \pm \frac{L^2+L_{n}^2-L_{f}^2}{2L}\sqrt{L_{n}^2-\bigg(\frac{L_{s}^2+L_{n}^2-L_{t}^2}{2L_{s}}\bigg)^2} \Bigg) \\
\end{align}

We then expand $L_{n}^2$...

\begin{align}
  X_{nm} &= \frac{L_{s}}{L_{n}}\Bigg( \Big(\frac{L^2+L_{s}^2+L_{t}^2-2L_{t}L_{s}\cos(\Theta_{nm})-L_{f}^2}{2L}\Big)\Big(\frac{2L_{s}^2-2L_{t}L_{s}\cos(\Theta_{nm})}{2L_{s}}\Big) \mp \\
  & \sqrt{L_{s}^2+L_{t}^2-2L_{t}L_{s}\cos(\Theta_{nm})-\bigg(\frac{L^2+L_{s}^2+L_{t}^2-2L_{t}L_{s}\cos(\Theta_{nm})-L_{f}^2}{2L}\bigg)^2}\sqrt{L_{s}^2+L_{t}^2-2L_{t}L_{s}\cos(\Theta_{nm})-\bigg(\frac{2L_{s}^2-2L_{t}L_{s}\cos(\Theta_{nm})}{2L_{s}}\bigg)^2} \Bigg) \\
  Y_{nm} &= \frac{L_{s}}{L_{n}}\Bigg(\frac{2L_{s}^2-2L_{t}L_{s}\cos(\Theta_{nm})}{2L_{s}}\sqrt{L_{s}^2+L_{t}^2-2L_{t}L_{s}\cos(\Theta_{nm})-\bigg(\frac{L^2+L_{s}^2+L_{t}^2-2L_{t}L_{s}\cos(\Theta_{nm})-L_{f}^2}{2L}\bigg)^2} \pm \\
  & \frac{L^2+L_{s}^2+L_{t}^2-2L_{t}L_{s}\cos(\Theta_{nm})-L_{f}^2}{2L}\sqrt{L_{s}^2+L_{t}^2-2L_{t}L_{s}\cos(\Theta_{nm})-\bigg(\frac{2L_{s}^2+-2L_{t}L_{s}\cos(\Theta_{nm})}{2L_{s}}\bigg)^2} \Bigg) \\
\end{align}

and $L_{f}^2$...

\begin{align}
  X_{nm} &= \frac{L_{s}}{L_{n}}\Bigg( \Big(\frac{L^2-2L_{t}L_{s}\cos(\Theta_{nm})+2L_{t}L_{s}\cos(\Theta_{fm})}{2L}\Big)\Big(\frac{2L_{s}^2-2L_{t}L_{s}\cos(\Theta_{nm})}{2L_{s}}\Big) \mp \\
  & \sqrt{L_{s}^2+L_{t}^2-2L_{t}L_{s}\cos(\Theta_{nm})-\bigg(\frac{L^2-2L_{t}L_{s}\cos(\Theta_{nm})+2L_{t}L_{s}\cos(\Theta_{fm})}{2L}\bigg)^2}\sqrt{L_{s}^2+L_{t}^2-2L_{t}L_{s}\cos(\Theta_{nm})-\bigg(\frac{2L_{s}^2-2L_{t}L_{s}\cos(\Theta_{nm})}{2L_{s}}\bigg)^2} \Bigg) \\
  Y_{nm} &= \frac{L_{s}}{L_{n}}\Bigg(\frac{2L_{s}^2-2L_{t}L_{s}\cos(\Theta_{nm})}{2L_{s}}\sqrt{L_{s}^2+L_{t}^2-2L_{t}L_{s}\cos(\Theta_{nm})-\bigg(\frac{L^2-2L_{t}L_{s}\cos(\Theta_{nm})+2L_{t}L_{s}\cos(\Theta_{fm})}{2L}\bigg)^2} \pm \\
  & \frac{L^2-2L_{t}L_{s}\cos(\Theta_{nm})+2L_{t}L_{s}\cos(\Theta_{fm})}{2L}\sqrt{L_{s}^2+L_{t}^2-2L_{t}L_{s}\cos(\Theta_{nm})-\bigg(\frac{2L_{s}^2+-2L_{t}L_{s}\cos(\Theta_{nm})}{2L_{s}}\bigg)^2} \Bigg) \\
\end{align}

We then do some simplification...

\begin{align}
  X_{nm} &= \frac{L_{s}}{L_{n}}\Bigg( \Big(\frac{L^2+2L_{t}L_{s}(\cos(\Theta_{fm})-\cos(\Theta_{nm}))}{2L}\Big)\Big(2L_{s}-L_{t}\cos(\Theta_{nm})\Big) \mp \\
  & \sqrt{L_{s}^2+L_{t}^2-2L_{t}L_{s}\cos(\Theta_{nm})-\bigg(\frac{L^2+2L_{t}L_{s}(\cos(\Theta_{fm})-\cos(\Theta_{nm}))}{2L}\bigg)^2}\sqrt{L_{t}^2-L_{t}^2\cos^2(\Theta_{nm})} \Bigg) \\
  Y_{nm} &= \frac{L_{s}}{L_{n}}\Bigg(L_{s}-L_{t}\cos(\Theta_{nm})\sqrt{L_{s}^2+L_{t}^2-2L_{t}L_{s}\cos(\Theta_{nm})-\bigg(\frac{L^2+2L_{t}L_{s}(\cos(\Theta_{fm})-\cos(\Theta_{nm}))}{2L}\bigg)^2} \pm \\
  & \frac{L^2+2L_{t}L_{s}(\cos(\Theta_{fm})-\cos(\Theta_{nm}))}{2L}\sqrt{L_{t}^2-L_{t}^2\cos^2(\Theta_{nm})} \Bigg) \\
\end{align}

And even more simplification...

\begin{align}
  X_{nm} &= \frac{L_{s}}{L_{n}}\Bigg( \Big(\frac{L^2+2L_{t}L_{s}(\cos(\Theta_{fm})-\cos(\Theta_{nm}))}{2L}\Big)\Big(2L_{s}-L_{t}\cos(\Theta_{nm})\Big) \mp \\
  & L_{t}\sin(\Theta_{nm})\sqrt{L_{s}^2+L_{t}^2-2L_{t}L_{s}\cos(\Theta_{nm})-\bigg(\frac{L^2+2L_{t}L_{s}(\cos(\Theta_{fm})-\cos(\Theta_{nm}))}{2L}\bigg)^2} \Bigg) \\
  Y_{nm} &= \frac{L_{s}}{L_{n}}\Bigg((L_{s}-L_{t}\cos(\Theta_{nm}))\sqrt{L_{s}^2+L_{t}^2-2L_{t}L_{s}\cos(\Theta_{nm})-\bigg(\frac{L^2+2L_{t}L_{s}(\cos(\Theta_{fm})-\cos(\Theta_{nm}))}{2L}\bigg)^2} \pm \\
  & \frac{L^2+2L_{t}L_{s}(\cos(\Theta_{fm})-\cos(\Theta_{nm}))}{2L}L_{t}\sin(\Theta_{nm}) \Bigg) \\
\end{align}

We then combine terms and make the equations messier (TODO: Finish this part):

\begin{multline}
  X_{nm} = \frac{L_{s}}{L_{n}}\Bigg( \Big(\frac{2L^2L_s - L^2L_t\cos(\Theta_{nm}) + 4L_{t}L_{s}^2(\cos(\Theta_{fm})-\cos(\Theta_{nm})) - 2L_{t}^2L_{s}(\cos(\Theta_{fm})\cos(\Theta_{nm}) - \cos^2(\Theta_{nm}))}{2L}\Big) \mp \\
\hspace*{-2 cm}  L_{t}\sin(\Theta_{nm})\sqrt{L_{s}^2+L_{t}^2-2L_{t}L_{s} \cos(\Theta_{nm})-\bigg(
    \frac{L^2+4L_{t}^2L_{s}^2\cos^2(\Theta_{fm})+ 4L_{t}^2L_{s}^2\cos^2(\Theta_{nm}) - 8L_{t}^2L_{s}^2\cos(\Theta_{fm})\cos(\Theta_{nm}) + 4L^2L_{t}L_{s}\cos(\Theta_{fm}) - 4L^2L_{t}L_{s}\cos(\Theta_{nm})}{2L}\bigg)} \Bigg) \\
  Y_{nm} = \frac{L_{s}}{L_{n}}\Bigg((L_{s}-L_{t}\cos(\Theta_{nm}))\sqrt{L_{s}^2+L_{t}^2-2L_{t}L_{s}\cos(\Theta_{nm})-\bigg(\frac{L^2+2L_{t}L_{s}(\cos(\Theta_{fm})-\cos(\Theta_{nm}))}{2L}\bigg)^2} \pm \\
   \frac{L^2+2L_{t}L_{s}(\cos(\Theta_{fm})-\cos(\Theta_{nm}))}{2L}L_{t}\sin(\Theta_{nm}) \Bigg) \\
\end{multline}

We can also use the law of cosines to find an expression for $\Theta_{1}$:

\begin{align}
   L_f^2 &= L^2 + L_n^2 - 2LL_n\cos(\Theta_{1}) \\
   \Theta_{1} &= \cos^{-1}(\frac{L^2+L_n^2-L_f^2}{2LL_n}) \\
\end{align}

We use this to find the value of $X_{t}$:

\begin{align}
  X_{t} &= L_n\cos(\Theta_{1}) \\
       &= \frac{L^2+L_n^2-L_f^2}{2L} \\
       &= \frac{L^2 + L_s^2 + L_t^2 - 2L_tL_s\cos(\Theta_{nm}) - L_s^2 - L_t^2 + 2L_sL_t\cos(\Theta_{fm})}{2L} \\
       &= \frac{L^2 + 2L_tL_s\big(\cos(\Theta_{fm})-\cos(\Theta_{nm})\big)}{2L}
\end{align}

To find $Y_{t}$ we do something similar:

\begin{align}
  \Theta_{1} &= \cos^{-1}(\frac{L^2+L_n^2-L_f^2}{2LL_n}) \\
  Y_{t} &= L_n\sin(\Theta_{1}) \\
  &= L_n\sin(\cos^{-1}(\frac{L^2+L_n^2-L_f^2}{2LL_n})) \\
  &= L_n\sqrt{1 - \big(\frac{(L^2+L_n^2-L_f^2}{2LL_n}\big)^2} \\
  &= L_n\sqrt{1 - (\frac{(L^2 + L_{s}^2+L_{t}^2-2L_{t}L_{s}\cos(\Theta_{nm}) - (L_{s}^2+L_{t}^2-2L_{t}L_{s}\cos(\Theta_{fm})))^2}{4L^2L_n^2})} \\
  &= L_n\sqrt{1 - (\frac{(L^2 - 2L_{t}L_{s}(\cos(\Theta_{fm}) - \cos(\Theta_{nm})))^2}{4L^2L_n^2})} \\
  &= L_n\sqrt{1 - (\frac{(L^4 + 4L_{t}^2L_{s}^2(\cos^2(\Theta_{fm}) + \cos^2(\Theta_{nm}) - 2\cos(\Theta_{fm})\cos(\Theta_{nm})) - 4L^2L_{t}L_{s}(\cos(\Theta_{fm}) - \cos(\Theta_{nm})))}{4L^2(L_{s}^2+L_{t}^2-2L_{t}L_{s}\cos(\Theta_{nm}))})} \\
\end{align}
...
This section shows the velocity definitions using the Brownian dynamics equation. \\
\begin{align}  
  \dot{X}_{nb} &= \frac{1}{\gamma} \Big(F_{xnb} + \lambda_{fs}(X_{nm} - X_{nb})\Big) + R_{xnb} \\
...
\begin{align}  
  \dot{Y}_{nb} &= \frac{1}{\gamma} \Big(F_{ynb} + \lambda_{fs}(Y_{nm} - Y_{nb})\Big) + R_{ynb} \\
