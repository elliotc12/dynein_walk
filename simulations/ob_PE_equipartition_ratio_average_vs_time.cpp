...
int main(int argc, char** argv) {
  ...
  strcpy(bba_eq_fname, "data/bba_pe_equipartition_ratio_v_time_");
  strcpy(bma_eq_fname, "data/bma_pe_equipartition_ratio_v_time_");
  strcpy(ta_eq_fname,  "data/ta_pe_equipartition_ratio_v_time_" );
  strcpy(uma_eq_fname, "data/uma_pe_equipartition_ratio_v_time_");
