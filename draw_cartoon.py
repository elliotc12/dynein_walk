...
def draw(x_coords, y_coords, alpha=1):
    figure_xs = np.array(x_coords)
    figure_ys = np.array(y_coords)

    # print("figure_xs", figure_xs)
    # print("x_coords", x_coords)
    ax = plt.gca()
    ax.add_artist(plt.Circle((figure_xs[0], figure_ys[0]), 0.05, color='blue'))
    ax.add_artist(plt.Circle((figure_xs[1], figure_ys[1]), 0.2, color='blue'))
    ax.add_artist(plt.Circle((figure_xs[2], figure_ys[2]), 0.1, color='grey'))
    ax.add_artist(plt.Circle((figure_xs[3], figure_ys[3]), 0.2, color='red'))
    ax.add_artist(plt.Circle((figure_xs[4], figure_ys[4]), 0.05, color='red'))

    plt.plot([figure_xs[0], figure_xs[1]], [figure_ys[0], figure_ys[1]], color="black", linewidth=0.5, alpha=alpha)
    plt.plot([figure_xs[1], figure_xs[2]], [figure_ys[1], figure_ys[2]], color="black", linewidth=0.5, alpha=alpha)
    plt.plot([figure_xs[2], figure_xs[3]], [figure_ys[2], figure_ys[3]], color="black", linewidth=0.5, linestyle=":", alpha=alpha)
    plt.plot([figure_xs[3], figure_xs[4]], [figure_ys[3], figure_ys[4]], color="black", linewidth=0.5, linestyle=":", alpha=alpha)
