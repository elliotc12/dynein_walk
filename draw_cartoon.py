...
def draw_cartoon(near_foot_figure_coords, x_coords, y_coords, x_scaling, y_scaling):
    ...
    plt.plot([figure_xs[0], figure_xs[1]], [figure_ys[0], figure_ys[1]], color="black", zorder=4, linewidth=0.5)
    plt.plot([figure_xs[1], figure_xs[2]], [figure_ys[1], figure_ys[2]], color="black", zorder=4, linewidth=0.5)
    ...
    plt.plot([figure_xs[4]], [figure_ys[4]], marker='o', markeredgecolor='k', markeredgewidth=0.4, zorder=2, color="red",   markersize=2*x_scaling*50)
    plt.plot([figure_xs[3]], [figure_ys[3]], marker='o', markeredgecolor='k', markeredgewidth=0.4, zorder=3, color="white", markersize=6*x_scaling*50)
    plt.plot([figure_xs[2]], [figure_ys[2]], marker='o', markeredgecolor='k', markeredgewidth=0.4, zorder=4, color="white", markersize=2*x_scaling*50)
    plt.plot([figure_xs[1]], [figure_ys[1]], marker='o', markeredgecolor='k', markeredgewidth=0.4, zorder=5, color="white", markersize=6*x_scaling*50)
    plt.plot([figure_xs[0]], [figure_ys[0]], marker='o', markeredgecolor='k', markeredgewidth=0.4, zorder=6, color="blue",  markersize=2*x_scaling*50)

    plt.gca().add_patch(Rectangle((figure_xs[0], -0.15), 0.01, 0.3, facecolor='k', alpha=0.8, zorder=-1))

def draw_cartoon_movie_edition(near_foot_figure_coords, state, x_coords, y_coords, x_scaling, y_scaling, alpha):
    if (state == 0):
