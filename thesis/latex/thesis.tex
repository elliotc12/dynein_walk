...
\begin{figure}[h]
  \centering
  \includegraphics[width=.65\textwidth,keepaspectratio]{../../figures/onebound-model}
  \caption{}
...
The model assumes MT-bound dynein can assume one of two states: one where both MTBDs are bound, and one where only one MTBD is bound to the MT. The states are also differentiated by different motor equilibrium angles and different transition rates.
...
\subsubection{Onebound state}

\subsubsection{Bothbound state}
