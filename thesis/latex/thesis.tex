...
In reality, all molecules have a degree of elasticity. A dynein model by Sarlah \textit{et. al.} models the dynein stalk as an elastic rod \cite{sarlahpaper}. However, the timescale of harmonic stalk oscillations is likely much quicker than that of the mechanochemical cycle, so it is reasonable to model the stalk as a rigid rod at the stalk's average extension length.\\
...
Treating the conformational dynamics of the domains as harmonic energies is a simplification, but 
