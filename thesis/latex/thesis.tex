...
This thesis aims to test whether Brownian motion and flexibility are what give rise to dynein's unique stepping pattern. To do this, an artificial motor model is created which exhibits flexibility and is affected by Brownian motion. This model is then simulated, and its behavior are compared to the behavior of real dynein.
