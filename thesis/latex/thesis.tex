...
More detailed stepping information is shown in Figure \ref{fig:stepping-trajectory}. The model steps both forwards and backwards, but has a definite forward bias. 

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{../../figures/stepping-trajectory}
