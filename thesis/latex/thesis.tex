...
The basic form is simple. Kinesin, myosin and dynein each have two foot domains which each alternatingly act as levers. One foot will bind to a surface and apply a force, levering the whole motor forward. This causes the other foot to bind and the cycle to repeat. This design is simple, but the ways each motor implement it are very different. Binding to the .........
...
Todo:
figure out how myosin works
explain how the motors are all really similar in structure
also how they're all kind of carnot-like engines which take in energy and do work
explain how dynein is much more stochastic than kinesin, and how this is interesting, since it hints at a Brownian component, which isn't present in kinesin
Talk about how confirming brownian component of the cycle would be good
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{../../plots/kb-kub-contour}
