...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.2\textwidth]{../../plots/stepping-ghost}
  \caption{Snapshots of model over the course of a simulation. Bothbound states are depicted immediately after binding events. Onebound states depict the conformation with the highest unbound binding domain between binding events. Simulation run at standard conditions with $k_b=123 s^{-1}, k_{ub}=456 s^{-1}, c_b=c_m=c_t=789 \Delta G_{ATP}$.}
  \label{fig:stepping-ghosts}
\end{figure}
...
\begin{figure}[H]
  \centering
    ...
    \includegraphics[width=0.5\textwidth]{../../plots/stepping_time_histogram_thesis}
    \includegraphics[width=0.5\textwidth]{../../figures/weihong-step-size.pdf}%%
    \includegraphics[width=0.5\textwidth]{../../figures/weihong-velocity.pdf}
