...
Despite these differences, the two motors implement very similar chemical cycles to achieve motion. Both motors begin bound to the microtubule, then bind ATP, causing them to lift one foot off. They then hydrolyse the ATP, causing their feet to kick forward and rebind. They then 
