...
Each of the models described above postulates a series of chemical events which occur during the dynein step. Testing such hypotheses can be done in a variety of ways. 
