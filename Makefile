...
ob_plots: create_ob_plots FORCE
	...
	./make_plot.py --figtitle="Angle_n_PE_$(TITLE)" --xlabel="Runtime (s)" --ylabel="Angle/PE" data/ob_uma_angle_$(TITLE).txt data/ob_uma_pe_$(TITLE).txt data/ob_config_$(TITLE).txt
