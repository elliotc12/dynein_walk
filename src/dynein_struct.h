...
extern bool am_only_writing_on_crash, angle_logging_mode, long_angle_logging_mode;
...
extern const bool frozen_in_bothbound;
...
const bool am_avoiding_sub_MT = false;
