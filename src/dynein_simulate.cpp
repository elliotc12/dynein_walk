...
void simulateOneboundOnly(double rand_seed, double* init_position, State s = NEARBOUND ) {
  ...
  dyn_ob = new Dynein_onebound(dyn_bb, rand, NEARBOUND);  // do we want this in nearbound or farbound?
  double t = 0;
  long long iter = 0;
