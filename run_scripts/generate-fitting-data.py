...
os.rename("../data/stepping_movie_data_%s.txt" % (basename), "../data/fitting_movie_data.txt")
os.rename("../data/stepping_data_%s.txt" % (basename), "../data/fitting_stepping_data.txt")
os.rename("../data/stepping_parameters_%s.tex" % (basename), "../data/fitting_stepping_parameters.tex")
